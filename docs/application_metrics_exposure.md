...
In kind or minikube clusters, kube-state-metrics often suppresses custom labels by default, making it impossible to filter metrics by labels like app, layer or version in PromQL.

...
public class TrialHelpers {
    ...
    public static ExperimentTrial createDefaultExperimentTrial(int trialNumber,
        ...
        DataSourceInfo datasourceInfo = new DataSourceInfo(KruizeDeploymentInfo.monitoring_agent, KruizeConstants.SupportedDatasources.PROMETHEUS, KruizeDeploymentInfo.monitoring_service, new URL(KruizeDeploymentInfo.monitoring_agent_endpoint));

...
public class MetricsConfig {
    ...
    public static Timer timerLoadRecExpName, timerLoadResultsExpName, timerLoadExpName, timerLoadBulkJobId, timerUpdateBulkJobId, timerLoadRecExpNameDate, timerBoxPlots;
    public static Timer timerLoadAllRec, timerLoadAllExp, timerLoadAllResults;
    public static Timer timerAddRecDB, timerAddResultsDB, timerAddExpDB, timerSaveBulkJobDB, timerAddBulkResultsDB, timerAddBulkJob;
    ...
    public static Timer.Builder timerBAddRecDB, timerBAddResultsDB, timerBAddExpDB, timerBLoadBulkJobId, timerBUpdateBulkJobId, timerBSaveBulkJobDB, timerBaddBulkJob, timerBAddBulkResultsDB;

 ...
 */
public class ValidateKruizeObject
{
	private ValidateKruizeObject() { }
	...
	public static StringBuilder validate(HashMap<String, Object> map) {
		...
		if (!KruizeSupportedTypes.MODES_SUPPORTED.contains((String)map.get(AnalyzerConstants.AutotuneObjectConstants.MODE))) {
		...
		if (!KruizeSupportedTypes.TARGET_CLUSTERS_SUPPORTED.contains((String)map.get(AnalyzerConstants.AutotuneObjectConstants.TARGET_CLUSTER))) {

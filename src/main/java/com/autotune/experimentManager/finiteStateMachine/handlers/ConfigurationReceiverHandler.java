...
package com.autotune.experimentManager.finiteStateMachine.handlers;
...
import com.autotune.experimentManager.finiteStateMachine.objects.MetricObject;
...
public class ConfigurationReceiverHandler implements EMEventHandler<RecommendedConfigReceiveEvent> {
    ...
    private ExperimentTrialObject getExperimentTrialObject(ExperimentTrialObject trialInput) throws IOException {
        ...
        JSONObject recJSONObject = AutotuneUtil.retriveDataFromURL(trialInput.getURL());

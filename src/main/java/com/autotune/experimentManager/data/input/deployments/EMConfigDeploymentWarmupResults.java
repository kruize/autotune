...
public class EMConfigDeploymentWarmupResults implements ConvertToJSON {
    private EMCollectiveCyclesMetrics collectiveCyclesMetrics;

    public EMConfigDeploymentWarmupResults() {
    ...
    public JSONObject toJSON() throws EMDataObjectIsInEditingException, EMDataObjectIsNotFilledException {
        ...
        jsonObject.put(EMConstants.EMJSONKeys.WARMUP_RESULTS, collectiveCyclesMetrics.toJSON());
        return jsonObject;
    }
}

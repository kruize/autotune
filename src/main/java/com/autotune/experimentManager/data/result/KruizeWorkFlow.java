 ...
 */
public class KruizeWorkFlow {
    private static final Logger LOGGER = LoggerFactory.getLogger(KruizeWorkFlow.class);
    ...
    public KruizeWorkFlow(boolean do_experiment, boolean do_monitoring, boolean wait_for_load, String trialResultURL) throws Exception {

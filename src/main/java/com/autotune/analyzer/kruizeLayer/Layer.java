...
public final class Layer {
    ...
    public Layer(String apiVersion, String kind, LayerMetadata metadata, LayerPresence layerPresence, List<LayerTunable> tunables) {
    ...
    public List<LayerTunable> getTunables() {
        return tunables;
    }

    public void setTunables(List<LayerTunable> tunables) {
        this.tunables = tunables;
    }

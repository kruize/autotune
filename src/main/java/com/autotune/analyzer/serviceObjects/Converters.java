            ...
            try {
                ...
                for (K8sObject k8sObject : kruizeObject.getKubernetes_objects()) {
                    ...
                    if (null != clonedNamespaceData) {
                        LOGGER.info("INSIDE IF CLONED NAMESPACE NOT NULL");
                        HashMap<Timestamp, MappedRecommendationForTimestamp> recommendations = clonedNamespaceData.getNamespaceRecommendations().getData();
                        LOGGER.info("Recommendations: " + recommendations.toString());
                            clonedNamespaceData.getNamespaceRecommendations().setData(recommendations);
                            namespaceAPIObject = new NamespaceAPIObject(clonedNamespaceData.getNamespace_name(),
                                    ...
                                    null);
                            LOGGER.info("clonedNamespaceData: {}", namespaceAPIObject);
                    }

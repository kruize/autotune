...
public class ListAutotuneTunables extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (KruizeDeployment.autotuneConfigMap.isEmpty()) {
        ...
        if (layerName != null) {
            if (KruizeDeployment.autotuneConfigMap.containsKey(layerName)) {
                JSONObject layerJson = new JSONObject();
                autotuneConfig = KruizeDeployment.autotuneConfigMap.get(layerName);
            ...
            for (String layer : KruizeDeployment.autotuneConfigMap.keySet()) {
                JSONObject layerJson = new JSONObject();
                autotuneConfig = KruizeDeployment.autotuneConfigMap.get(layer);
                addLayerDetails(layerJson, autotuneConfig);
                JSONArray tunablesArray = new JSONArray();
                addLayerTunableDetails(tunablesArray, autotuneConfig, sloClass);
                if (!tunablesArray.isEmpty()) {

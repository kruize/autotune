...
public class Terms {
    ...
    public static boolean checkIfMinDataAvailableForTermNamespace(NamespaceData namespaceData, Terms term, Timestamp monitoringEndTime,
                                                                  double measurementDuration) {
        // Check if data is available
    ...
    public static void setDurationBasedOnTermNamespace(NamespaceData namespaceData, TermRecommendations
            mappedRecommendationForTerm, String recommendationTerm) {

...
public class RecommendationConstants {
    ...
    public enum RecommendationTerms {
        ...
        private RecommendationTerms(String value, int durationInHrs, double upperBound, double lowerBound, int plots_datapoints) {
            this.value = value;

...
/**
 * Storage object for recommendation engine summary
 */

public class RecommendationTimestampLevelSummary {
    ...
    @SerializedName("recommendation_terms")
    private HashMap<String, RecommendationSummary> recommendationSummaryHashMap;
    @SerializedName("timestamp_level_notifications_summary")
    private NotificationsSummary notificationsSummary;
    @SerializedName("action_summary")
    private ActionSummary actionSummary;

    public HashMap<String, RecommendationSummary> getRecommendationSummaryHashMap() {
        return recommendationSummaryHashMap;
    }

    public void setRecommendationSummaryHashMap(HashMap<String, RecommendationSummary> recommendationSummaryHashMap) {
        this.recommendationSummaryHashMap = recommendationSummaryHashMap;
    }
...
//    public RecommendationEngineSummary mergeSummaries(RecommendationEngineSummary existingSummary, RecommendationEngineSummary currentSummary) {
//        Summarize summarize = new Summarize();
//        RecommendationEngineSummary mergedSummary = new RecommendationEngineSummary();
//        try {
...
//    }
    ...
    public String toString() {
        return "RecommendationTimestampLevelSummary{" +
                "currentConfig=" + currentConfig +
                ", recommendationSummaryHashMap=" + recommendationSummaryHashMap +

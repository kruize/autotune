...
public class RecommendationEngineSummary {
    private static final Logger LOGGER = LoggerFactory.getLogger(RecommendationEngineSummary.class);
    ...
    @SerializedName("engine_level_notifications_summary")
    ...
    public RecommendationEngineSummary mergeEngineSummaries(RecommendationEngineSummary existingSummary, RecommendationEngineSummary currentSummary) {

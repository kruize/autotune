...
public class DBConstants {
    ...
    public static final class SQLQUERY {
        ...
        public static final String SELECT_FROM_METADATA_PROFILE = "from KruizeMetadataProfileEntry";
        public static final String SELECT_FROM_METADATA_PROFILE_BY_NAME = "from KruizeMetadataProfileEntry k WHERE k.name = :name";

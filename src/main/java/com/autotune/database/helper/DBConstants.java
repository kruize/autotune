...
public class DBConstants {
    ...
    public static final class SQLQUERY {
        ...
        public static final String UPDATE_BULKJOB_BY_ID = "UPDATE kruize_bulkjobs SET experiments = jsonb_set(     experiments,     '{experiments}',     (experiments->'experiments' || CAST(:newFragment AS jsonb)) ,     true ) , processed_count= :processed_count , total_count= :total_count WHERE job_id = :jobId";

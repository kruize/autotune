...
/**
 * This is a Java class named KruizeMetadataProfileEntry annotated with JPA annotations.
 * It represents a table named kruize_metadata_profiles in a relational database.
 * <p>
 ...
 */
@Entity
@Table(name = "kruize_metadata_profiles")
public class KruizeMetadataProfileEntry {

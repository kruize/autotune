...
/**
 * This class used to generate a even compare and benchmark the result received from the training deployments.
 * @author Bipin Kumar
 *
 * Mar 30, 2021
 */
public class BenchMarkResultEvent extends EMAbstractEvent {
	...
	public BenchMarkResultEvent(ExperimentTrialObject data) {

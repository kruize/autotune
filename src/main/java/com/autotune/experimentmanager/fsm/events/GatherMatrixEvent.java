...
/**
 * GatherMatrixEvent is generating the event in case of receive matrix from the monitoring tools like prometheous etc.
 * @author Bipin Kumar
 *
 * @Date Mar 31, 2021
 */
public class GatherMatrixEvent extends EMAbstractEvent {
	...
	public GatherMatrixEvent(ExperimentTrialObject data) {

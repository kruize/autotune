...
AUTOTUNE_PERF_PROFILE_CRD="manifests/performance-profiles/kruize-performance-profile-crd.yaml"
AUTOTUNE_PERF_PROFILE_ROS="manifests/performance-profiles/resource_optimization_openshift.yaml"

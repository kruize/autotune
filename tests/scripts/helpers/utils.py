...
CREATE_BULK_CONFIG_SUCCESS_MSG = "Bulk config created successfully"
BULK_CONFIG_EXISTS_MSG = "Bulk config with name '%s' already exists"
BULK_CONFIG_NOT_FOUND_MSG = "Bulk config not found: %s"
UPDATE_BULK_CONFIG_SUCCESS_MSG = "Bulk config updated successfully"
DELETE_BULK_CONFIG_SUCCESS_MSG = "Bulk config deleted successfully"
BULK_CONFIG_MISSING_CONFIG_NAME = "config_name is required"
BULK_CONFIG_MISSING_CLUSTER_NAME = "cluster_name is required"
BULK_CONFIG_MISSING_DATASOURCES = "At least one datasource is required"
BULK_CONFIG_MISSING_EXPERIMENT_TYPES = "At least one experiment_type is required"
BULK_CONFIG_MISSING_METADATA_PROFILE = "metadata_profile is required"
BULK_CONFIG_MISSING_RECOMMENDATION_SETTINGS = "recommendation_settings is required"
BULK_CONFIG_INVALID_CONFIG_NAME = "config_name must contain only alphanumeric characters, hyphens, and underscores"
BULK_CONFIG_DATASOURCE_NOT_EXIST = "does not exist. Please create it first"
BULK_CONFIG_METADATA_PROFILE_NOT_EXIST = "metadata_profile '%s' does not exist. Please create it first using the createMetadataProfile API."
BULK_CONFIG_PERFORMANCE_PROFILE_NOT_EXIST = "performance_profile '%s' does not exist. Please create it first using the createPerformanceProfile API."

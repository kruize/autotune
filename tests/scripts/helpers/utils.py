...
LAYER_QUERY_MISSING_QUERY_FIELD_MSG = "Validation failed: Query object must have 'query' field"
LAYER_QUERY_EMPTY_DATASOURCE_MSG = "Validation failed: Query datasource cannot be empty"
LAYER_QUERY_EMPTY_QUERY_STRING_MSG = "Validation failed: Query string cannot be empty"
LAYER_QUERY_NULL_DATASOURCE_MSG = "Validation failed: Query datasource cannot be null"
LAYER_QUERY_NULL_QUERY_MSG = "Validation failed: Query string cannot be null"
LAYER_QUERY_INVALID_PROMQL_MSG = "Validation failed: Query validation failed"
LAYER_LABEL_MISSING_NAME_MSG = "Validation failed: Label object must have 'name' field"
LAYER_LABEL_MISSING_VALUE_MSG = "Validation failed: Label object must have 'value' field"
LAYER_LABEL_NULL_NAME_MSG = "Validation failed: Label name cannot be null"
LAYER_LABEL_NULL_VALUE_MSG = "Validation failed: Label value cannot be null"
LAYER_LABEL_EMPTY_NAME_MSG = "Validation failed: Label name cannot be empty"
LAYER_LABEL_EMPTY_VALUE_MSG = "Validation failed: Label value cannot be empty"
...
TUNABLE_MISSING_VALUE_TYPE_MSG = "Validation failed: Tunable '%s' missing value_type field"
TUNABLE_ONLY_UPPER_BOUND_MSG = "Validation failed: Tunable '%s' has upper_bound but missing lower_bound"
TUNABLE_ONLY_LOWER_BOUND_MSG = "Validation failed: Tunable '%s' has lower_bound but missing upper_bound"
TUNABLE_BOUNDS_WITHOUT_STEP_MSG = "Validation failed: Tunable '%s' has bounds but missing step"
LAYER_MISSING_METADATA_MSG = "Validation failed: Request must have 'metadata' object"
LAYER_MISSING_APIVERSION_MSG = "Validation failed: Request must have 'apiVersion' field"
LAYER_MISSING_KIND_MSG = "Validation failed: Request must have 'kind' field"
LAYER_INVALID_KIND_MSG = "Validation failed: 'kind' must be 'KruizeLayer', got: %s"
LAYER_INVALID_APIVERSION_MSG = "Validation failed: Invalid apiVersion format: %s"
...
LAYER_QUERY_NULL_DATASOURCE_MSG = "Validation failed: Query datasource cannot be null"
LAYER_QUERY_NULL_QUERY_MSG = "Validation failed: Query string cannot be null"
LAYER_QUERY_INVALID_PROMQL_MSG = "Validation failed: Invalid PromQL syntax in query"
LAYER_LABEL_MISSING_NAME_MSG = "Validation failed: Label object must have 'name' field"
LAYER_LABEL_MISSING_VALUE_MSG = "Validation failed: Label object must have 'value' field"
LAYER_LABEL_NULL_NAME_MSG = "Validation failed: Label name cannot be null"
LAYER_LABEL_NULL_VALUE_MSG = "Validation failed: Label value cannot be null"

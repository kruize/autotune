...
def test_list_recommendations_multiple_exps_for_datasource_workloads(cluster_type):
    ...
    container_exp_content = template.render(
       ...
       namespace="default", namespace_name=None, container_image_name="quay.io/kruizehub/sysbench", container_name="sysbench", measurement_duration="2min",
       threshold="0.1", models=["cost","performance"], terms=["short","medium","long"]
    )

...
def test_list_recommendations_multiple_exps_for_datasource_workloads(cluster_type):
    ...
    container_exp_content = template.render(
       ...
       namespace="default", namespace_name=None, container_image_name="quay.io/kruizehub/sysbench", container_name="sysbench", measurement_duration="1min", threshold="0.1"
    )
    ...
    namespace_exp_content = template.render(
        ...
        namespace=None, namespace_name="default", container_image_name=None, container_name=None, measurement_duration="1min", threshold="0.1"
    )

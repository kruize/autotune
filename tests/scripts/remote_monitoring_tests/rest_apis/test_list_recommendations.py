...
reco_term_input = [
    ("short_term_test", 1, list_reco_json_schema, SHORT_TERM_DURATION_IN_HRS_MAX),
    ("medium_term_test", 7, medium_term_list_reco_json_schema, MEDIUM_TERM_DURATION_IN_HRS_MAX),
    ("long_term_test", 15, long_term_list_reco_json_schema, LONG_TERM_DURATION_IN_HRS_MAX),
]
...
@pytest.mark.extended
@pytest.mark.parametrize("test_name, num_days, reco_json_schema, expected_duration_in_hours", reco_term_input)
@pytest.mark.parametrize("latest", ["true", "false"])

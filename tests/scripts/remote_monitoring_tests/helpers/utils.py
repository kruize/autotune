...
UPDATE_RECOMMENDATIONS_INTERVAL_END_TIME_NOT_FOUND = 'Not Found: interval_end_time does not exist: '
UPDATE_RECOMMENDATIONS_METRICS_NOT_FOUND = 'No metrics available from %s to %s '

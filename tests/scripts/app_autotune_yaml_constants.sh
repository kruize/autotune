...
[valid-objective-function]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-objective-function')
...
[no-mode]='error: error validating "'${path}/${app_autotune_tests[7]}/no-mode.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "mode" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' 
[no-mode-value]='error: error validating "'${path}/${app_autotune_tests[7]}/no-mode-value.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "mode" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' 
[null-mode]='error: error validating "'${path}/${app_autotune_tests[7]}/null-mode.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "mode" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' 

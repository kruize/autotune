...
# Other test cases for application autotune yaml
#other_tests=("incomplete_yaml")
...
sla_class_expected_log_msgs=([blank-slaclass]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: sla_class:   not supported' [invalid-slaclass]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: sla_class: rgyedg not supported' [multiple-slaclass]='error from crd' [multiple-sla-sections]='error from crd' [no-sla]='error: error validating "'${path}/${app_autotune_tests[1]}/no-sla.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "sla" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' [no-slaclass]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: sla_class:  not supported' [no-sla-value]='error: error validating "'${path}/${app_autotune_tests[1]}/no-sla-value.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "sla" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' [no-slaclass-value]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: sla_class:  not supported' [null-slaclass]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: sla_class:  not supported' [numerical-slaclass]='The Autotune "numerical-sla" is invalid: spec.sla.sla_class: Invalid value: "integer": spec.sla.sla_class in body must be of type string: "integer"' [valid-slaclass]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-sla')
...
function_variable_datasource_autotune_objects=([blank-function-variable-datasource]='true' [invalid-function-variable-datasource]='true' [multiple-function-variable-datasource]='false' [multiple-function-variable-datasource-sections]='false' [no-function-variable-datasource]='false' [no-function-variable-datasource-value]='false' [null-function-variable-datasource]='false' [numerical-function-variable-datasource]='false' [valid-function-variable-datasource]='true')
# Expected log message for sla function variable datasource
declare -A function_variable_datasource_expected_log_msgs
function_variable_datasource_expected_log_msgs=([blank-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datatype not supported' [invalid-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datatype not supported' [multiple-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datatype not supported' [multiple-function-variable-datasource-sections]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datatype not supported' [no-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datatype not supported' [no-function-variable-datasource-value]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datatype not supported' [null-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datatype not supported' [numerical-function-variable-datasource]='The Autotune "numerical-function-variable-datasource" is invalid: spec.sla.function_variables.datasource: Invalid value: "integer": spec.sla.function_variables.datasource in body must be of type string: "integer"' [valid-function-variable-datasource]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-function-variable-datasource' )

# Expected autotune object for function variable value type
declare -A function_variable_value_type_autotune_objects
function_variable_value_type_objective_function_autotune_objects=([blank-function-variable-value-type]='true' [invalid-function-variable-value-type]='true' [multiple-function-variable-value-type]='false' [multiple-function-variable-value-type-sections]='false' [no-function-variable-value-type]='false' [no-function-variable-value-type-value]='false' [null-function-variable-value-type]='false' [numerical-function-variable-value-type]='false' [valid-function-variable-value-type]='true')
# Expected log message for function variable value type
declare -A function_variable_value_type_expected_log_msgs
function_variable_value_type_expected_log_msgs=([blank-function-variable-value-type]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time value_type not supported' [invalid-function-variable-value-type]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time value_type not supported' [multiple-function-variable-value-type]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time value_type not supported' [multiple-function-variable-value-type-sections]='error from crd' [no-function-variable-value-type]='error: error validating "'${path}/${app_autotune_tests[6]}/no-function-variable-value-type.yaml'": error validating data: ValidationError(Autotune.spec.sla.function_variables\[0\]): missing required field "value_type" in com.recommender.v1.Autotune.spec.sla.function_variables; if you choose to ignore these errors, turn validation off with --validate=false' [no-function-variable-value-type-value]='error: error validating "'${path}/${app_autotune_tests[6]}/no-function-variable-value-type-value.yaml'": error validating data: ValidationError(Autotune.spec.sla.function_variables\[0\]): missing required field "value_type" in com.recommender.v1.Autotune.spec.sla.function_variables; if you choose to ignore these errors, turn validation off with --validate=false' [null-function-variable-value-type]='error: error validating "'${path}/${app_autotune_tests[6]}/null-function-variable-value-type.yaml'": error validating data: ValidationError(Autotune.spec.sla.function_variables\[0\]): missing required field "value_type" in com.recommender.v1.Autotune.spec.sla.function_variables; if you choose to ignore these errors, turn validation off with --validate=false' [numerical-function-variable-value-type]='The Autotune "numerical-function-variable-value-type" is invalid: spec.sla.function_variables.value_type: Invalid value: "integer": spec.sla.function_variables.value_type in body must be of type string: "integer"' [valid-function-variable-value-type]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-function-variable-value-type' )

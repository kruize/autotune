...
function_variable_datasource_autotune_objects=([blank-function-variable-datasource]='true' [invalid-function-variable-datasource]='true' [no-function-variable-datasource]='true' [no-function-variable-datasource-value]='true' [null-function-variable-datasource]='true' [numerical-function-variable-datasource]='false' [valid-function-variable-datasource]='true')
# Expected log message for sla function variable datasource
declare -A function_variable_datasource_expected_log_msgs
function_variable_datasource_expected_log_msgs=([blank-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datasource not supported' [invalid-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datasource not supported' [no-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datasource not supported' [no-function-variable-datasource-value]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datasource not supported' [null-function-variable-datasource]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time datasource not supported' [numerical-function-variable-datasource]='The Autotune "numerical-function-variable-datasource" is invalid: spec.sla.function_variables.datasource: Invalid value: "integer": spec.sla.function_variables.datasource in body must be of type string: "integer"' [valid-function-variable-datasource]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-function-variable-datasource' )

# Expected autotune object for function variable value type
declare -A function_variable_value_type_autotune_objects
function_variable_value_type_autotune_objects=([blank-function-variable-value-type]='true' [invalid-function-variable-value-type]='true' [no-function-variable-value-type]='false' [no-function-variable-value-type-value]='false' [null-function-variable-value-type]='false' [numerical-function-variable-value-type]='false' [valid-function-variable-value-type]='true')
# Expected log message for function variable value type
declare -A function_variable_value_type_expected_log_msgs
function_variable_value_type_expected_log_msgs=([blank-function-variable-value-type]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time value_type not supported' [invalid-function-variable-value-type]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: function_variable: transaction_response_time value_type not supported' [no-function-variable-value-type]='error: error validating "'${path}/${app_autotune_tests[6]}/no-function-variable-value-type.yaml'": error validating data: ValidationError(Autotune.spec.sla.function_variables\[0\]): missing required field "value_type" in com.recommender.v1.Autotune.spec.sla.function_variables; if you choose to ignore these errors, turn validation off with --validate=false' [no-function-variable-value-type-value]='error: error validating "'${path}/${app_autotune_tests[6]}/no-function-variable-value-type-value.yaml'": error validating data: ValidationError(Autotune.spec.sla.function_variables\[0\]): missing required field "value_type" in com.recommender.v1.Autotune.spec.sla.function_variables; if you choose to ignore these errors, turn validation off with --validate=false' [null-function-variable-value-type]='error: error validating "'${path}/${app_autotune_tests[6]}/null-function-variable-value-type.yaml'": error validating data: ValidationError(Autotune.spec.sla.function_variables\[0\]): missing required field "value_type" in com.recommender.v1.Autotune.spec.sla.function_variables; if you choose to ignore these errors, turn validation off with --validate=false' [numerical-function-variable-value-type]='The Autotune "numerical-function-variable-value-type" is invalid: spec.sla.function_variables.value_type: Invalid value: "integer": spec.sla.function_variables.value_type in body must be of type string: "integer"' [valid-function-variable-value-type]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-function-variable-value-type' )

# Expected autotune object for mode
declare -A mode_autotune_objects
mode_autotune_objects=([blank-mode]='true' [invalid-mode]='true' [no-mode]='false' [no-mode-value]='false' [null-mode]='false' [numerical-mode]='false' [valid-mode]='true')
# Expected log message for mode
declare -A mode_expected_log_msgs
mode_expected_log_msgs=([blank-mode]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Autotune object mode not supported' [invalid-mode]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Autotune object mode not supported' [no-mode]='error: error validating "'${path}/${app_autotune_tests[7]}/no-mode.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "mode" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' [no-mode-value]='error: error validating "'${path}/${app_autotune_tests[7]}/no-mode-value.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "mode" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' [null-mode]='error: error validating "'${path}/${app_autotune_tests[7]}/null-mode.yaml'": error validating data: ValidationError(Autotune.spec): missing required field "mode" in com.recommender.v1.Autotune.spec; if you choose to ignore these errors, turn validation off with --validate=false' [numerical-mode]='The Autotune "numerical-mode" is invalid: spec.mode: Invalid value: "integer": spec.mode in body must be of type string: "integer"' [valid-mode]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-mode' )

# Expected autotune object for label
declare -A label_autotune_objects
label_autotune_objects=([blank-label]='true' [invalid-label]='true' [no-label]='true' [no-label-value]='true' [null-label]='true' [numerical-label]='false' [valid-label]='true')
# Expected log message for label
declare -A label_expected_log_msgs
label_expected_log_msgs=([blank-label]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: label:   not supported' [invalid-label]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: label:   not supported' [no-label]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Invalid MatchLabel' [no-label-value]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Invalid MatchLabel' [null-label]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Invalid MatchLabel' [numerical-label]='The Autotune "numerical-label" is invalid: spec.selector.matchLabel: Invalid value: "integer": spec.selector.matchLabel in body must be of type string: "integer"' [valid-label]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-label' )

# Expected autotune object for label value
declare -A labelvalue_autotune_objects
labelvalue_autotune_objects=([blank-labelvalue]='true' [invalid-labelvalue]='true' [no-labelvalue]='true' [no-labelvalue-value]='true' [null-labelvalue]='true' [numerical-labelvalue]='false' [valid-labelvalue]='true')
# Expected log message for label value
declare -A labelvalue_expected_log_msgs
labelvalue_expected_log_msgs=([blank-labelvalue]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: labelvalue:   not supported' [invalid-labelvalue]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: labelvalue:   not supported' [no-labelvalue]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Invalid MatchLabelValue' [no-labelvalue-value]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Invalid MatchLabelValue' [null-labelvalue]='com.autotune.dependencyAnalyzer.exceptions.InvalidValueException: Invalid MatchLabelValue' [numerical-labelvalue]='The Autotune "numerical-labelvalue" is invalid: spec.selector.matchLabelValue: Invalid value: "integer": spec.selector.matchLabelValue in body must be of type string: "integer"' [valid-labelvalue]='com.autotune.dependencyAnalyzer.deployment.AutotuneDeployment - Added autotune object valid-labelvalue' )

# Expected autotune object for other test cases
declare -A other_autotune_objects
other_autotune_objects=([incomplete-autotune]='false' [invalid-direction-for-slaclass]='true')
# Expected log message for other test cases
declare -A other_expected_log_msgs
other_expected_log_msgs=([incomplete-autotune]='error: error validating "'${path}/${other_tests[0]}/incomplete-autotune.yaml'": error validating data: ValidationError(Autotune): missing required field "spec" in com.recommender.v1.Autotune; if you choose to ignore these errors, turn validation off with --validate=false' [invalid-direction-for-slaclass]='validation from da')

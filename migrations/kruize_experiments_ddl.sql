...
alter table if exists kruize_experiments add column experiment_type bigint not null default 1, add column creation_date timestamp(3) not null default current_timestamp, add column update_date timestamp(3) not null default current_timestamp;
